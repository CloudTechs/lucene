...
public class TokenSourcesTest extends LuceneTestCase {
  ...
  private static final class TokenStreamOverlap extends TokenStream {
    ...
    private final PositionIncrementAttribute positionIncrementAttribute = (PositionIncrementAttribute) addAttribute(PositionIncrementAttribute.class);
    ...
    public boolean incrementToken() throws IOException {
      ...
      clearAttributes();
      termAttribute.setTermBuffer(this.tokens[i].term());
  ...
  public void testOverlapWithOffset() throws CorruptIndexException,
    ...
    final IndexWriter indexWriter = new IndexWriter(directory, new OverlapAnalyzer(), IndexWriter.MaxFieldLength.UNLIMITED);
    try {
